...
Обратите внимание, что название файла пишется без расширения. Также важен отступ и пустая строка. Подробнее директива ``.. toctree::`` рассматривается в разделе :ref:`toctree-label` главы :ref:`sphinx-markup`.
